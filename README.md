# Smarthome Domain
Repository for the Domain layer of the Smarthome Hub project, which is a home automation system that allows users to control various smart devices in their home.
